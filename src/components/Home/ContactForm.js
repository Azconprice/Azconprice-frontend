        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="PlanInqury" className='text-black text-[18px]' >Plan Inqury</option>
              <option value="Support" className='text-black text-[18px]'>Support</option>
              <option value="Registration" className='text-black text-[18px]'>Registration</option>
              <option value="ComplaintAndSuggestion" className='text-black text-[18px]'>Complaint And Suggestion</option>
            </select>
