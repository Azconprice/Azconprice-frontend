...
const PlanPaymentModal = () => {
  return (
    <div className="fixed z-50 inset-0 backdrop-blur-lg bg-opacity-75 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl p-8 max-w-4xl w-full overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 md:pr-8 md:border-r-2 md:border-black pb-8 md:pb-0">
            ...
            <div className="flex flex-col gap-4">
              {/* Plan Card 1 */}
              <div className="text-white rounded-2xl md:rounded-lg flex items-center justify-between relative overflow-hidden plan-card-background">
