...
const PlanPaymentModal = ({
  ...
  const plans = [
    {
      id: "one-time",
      title: "Birdəfəlik plan",
      description:
        "Bu plan qeydiyyata ehtiyac olmadan\nistifade ede bilersiniz",
      price: "1000 Azn",
    },
    {
      id: "monthly",
      ...
      <div className="bg-white rounded-xl p-8 max-w-4xl w-full overflow-hidden relative">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 md:pr-8 md:border-r-2 md:border-black pb-8 md:pb-0">
            ...
            <p className="text-[#838080] text-[13px] mb-6">
              Sizin üçün möhtəşəm planlarımız var
            </p>
            {errors.plan && (
              ...
              {plans.map((plan) => (
                ...
                >
                  <div className=" flex flex-col gap-[5px] ">
                    <h3 className="text-[16px] font-semibold text-left pl-[15px] pt-[10px]">
                      {plan.title}
                    </h3>
                    <p
                      className="text-gray-400 text-[12px] pl-[15px] pb-[10px] text-left"
                      style={{ whiteSpace: "pre-line" }}
                    >
                      {plan.description}
                    </p>
                  </div>
                  <div className="text-[14px] font-bold border w-[135px] text-center border-orange-500 px-4 py-2 mr-[20px] rounded-[8px]">
                    {plan.price}
                  </div>
                </div>
              ))}
          ...
          <div className="flex-1 md:pl-8">
            ...
            {/* Şəxsi məlumatları */}
            <div className="mb-6">
              <h3 className="text-[13px] font-semibold text-[#838080] mb-3">
                Şəxsi məlumatları
              </h3>
              <div className="flex flex-row md:flex-row gap-4 w-full flex-shrink-0">
                ...
                <div className="w-full md:w-1/2">
                  <div
                    className={`flex items-center overflow-hidden rounded-full bg-[#EDE6E6] px-2 py-2 border ${
                      errors.phoneNumber
                        ? "border-red-500"
                        : "border-transparent"
                    }`}
                  >
                    <span className="pl-2 pr-2 text-gray-500 text-[14px]">
                      +994
                    </span>
                    <input
                      type="tel"
            ...
            <div className="flex items-center mb-6">
              ...
              />
              <label htmlFor="send-receipt" className="text-gray-700">
                Qəbzi E-poçt adresimə göndər
              </label>
            </div>
