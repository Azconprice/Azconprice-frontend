            ...
            <table className="w-full min-w-[800px]">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  {/* <th className="text-center py-4 px-4 font-semibold text-gray-700">Əməliyyatlar</th> */}
                </tr>
              </thead>
              <tbody>
                {filteredProducts.map((product, index) => (
                  <tr
                    key={product.id}
                    className={`border-b border-gray-50 hover:bg-gray-25 transition-colors ${index % 2 === 0 ? 'bg-gray-25' : 'bg-white'
                      }`}
                  >
