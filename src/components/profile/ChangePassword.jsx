        ...
        <>
            <div className="p-[32px] mt-[80px]">
                <div className="flex items-center justify-between">
                    <h3 className="text-[20px] font-[700] text-[#1E293B]">Təhlükəsizlik ayarları</h3>
                ...
                <div className="max-w-[800px]">
                    <div className="w-full flex justify-between mb-[24px] items-center">
                        <label htmlFor="password" className="font-[700] text-[16px] text-[#1E293B]">Cari şifrə</label>
                        <input
                            type="password"
                            name="password"
                            id="password"
                    ...
                    <div className="w-full flex justify-between mb-[24px] items-center">
                        <label htmlFor="newpassword" className="font-[700] text-[16px] text-[#1E293B]">Yeni şifrə</label>
                        <input
                            type="password"
                            name="newpassword"
                            id="newpassword"
                    ...
                    <div className="w-full flex justify-between mb-[24px] items-center">
                        <label htmlFor="newpasswordagain" className="font-[700] text-[16px] text-[#1E293B]">Yeni şifrə təkrarı</label>
                        <input
                            type="password"
